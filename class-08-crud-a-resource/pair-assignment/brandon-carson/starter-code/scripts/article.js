...
webDB.init();
  ...
  Article.createTable = function(callback) {
      webDB.execute("CREATE TABLE articles (title TEXT, category TEXT, author TEXT, authorUrl TEXT, publishedOn INT, body TEXT);",
      function(result) {
  ...
  Article.prototype.deleteRecord = function(callback) {
    webDB.execute(
      [
        {
          'sql': 'DELETE rowid FROM articles WHERE rowid = ?'
          'data': [this.rowid]
        }
      ],
      callback
  ...
  Article.prototype.updateRecord = function(callback) {
    webDB.execute(
      [
        {
          'sql': 'UPDATE articles (SET title = ?, category = ?, author = ?, authorURL = ?, publishedOn = ?, body = ? ) WHERE rowid = ?'
          'data': [this.title, this.category, this.author, this.authorUrl, this.publishedOn, this.body]
        }
      ],
      callback
